...
for dataset in tqdm(datasets):
    ...
    for index, row in data.iterrows():
        ...
        if row['Home'] not in teams_last_played:
            ...
            home_games_rested = current_date - teams_last_played[row['Home']]
        ...
        if row['Away'] not in teams_last_played:
            ...
            current_date = get_date(row['Date'])
            away_games_rested = current_date - teams_last_played[row['Away']]
            teams_last_played[row['Away']] = current_date
        
        # update date
        data.at[index,'Games_Rested_Away'] = away_games_rested.days
        data.at[index,'Games_Rested_Home'] = home_games_rested.days
